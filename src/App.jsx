                  ...
                  {myOrders.map(order => (
                    <article className="customer-order-pro" key={order.id}>
                      ...
                      {order.trackingNumber && (
                        <a href={`https://www.google.com/search?q=${order.shippingCompany} ${order.trackingNumber}`} target="_blank" style={{display:"block",marginTop:"10px",background:"#0F3D2E",color:"#fff",padding:"10px",borderRadius:"10px",textAlign:"center",textDecoration:"none"}}>
                          تتبع الشحنة
                        </a>
                      )}
                      </div>
